...
from shop2.money import Money, MoneyMaker
    {%- endif %}
from shop2.money.fields import MoneyField
from shop2.models.product import BaseProduct, BaseProductManager,{% if cookiecutter.stock_management == 'simple' %} AvailableProductMixin,{% endif %} CMSPageReferenceMixin
    {%- if cookiecutter.stock_management == 'inventory' %}
from shop2.models.inventory import BaseInventory, AvailableProductMixin
    {%- endif %}
{% endif -%}
from shop2.models.defaults.cart import Cart
from shop2.models.defaults.cart_item import CartItem
{% if cookiecutter.delivery_handling in ['partial', 'common'] -%}
from shop2.models.order import BaseOrderItem
from shop2.models.defaults.delivery import Delivery
from shop2.models.defaults.delivery_item import DeliveryItem
{% else -%}
from shop2.models.defaults.order_item import OrderItem
{% endif -%}
from shop2.models.defaults.order import Order
from shop2.models.defaults.mapping import ProductPage, ProductImage
...
{% else -%}
from shop2.models.defaults.address import BillingAddress, ShippingAddress
from shop2.models.defaults.customer import Customer
{% endif %}
